<?php
require_once('App/Controller/ListarGrupoController.php');
...
<body>
    <div class="col-xs-12">
                ...
                <ul class="navbar-nav">
                    ...
                    <li>
                        <form action="pesquisar-grupo.php" method="POST">
                            <input type="text" style="margin-left: 560px; width: 215px;" class="form-control" name="grupo_nome" placeholder="Digite sua busca aqui">
                    </li>
        ...
        ?>
        <h3 style="text-align: center; margin-top: 10px"> Seus grupos </h3>
